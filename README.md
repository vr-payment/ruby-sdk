...
The VRPayment Ruby SDK is used to interact with VRPayment's REST API.
...
application_user_id = '140366'
authentication_key = 'dvZsZdp+CLyi6RqBJuJER88CrrROHLz3VNuAkZI5U6s='
...
When working with webhooks, the `VrpaymentRubySdk::VRPaymentSdkException` may throw error codes to help with debugging.
...
begin
  # SDK operation
rescue VrpaymentRubySdk::ApiError => ex
  if VrpaymentRubySdk::ApiExceptionErrorCodes.is?(ex, VrpaymentRubySdk::ApiExceptionErrorCodes::CONFLICT)
