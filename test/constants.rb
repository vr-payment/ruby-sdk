...
SPACE_ID = '82470'
TEST_USER_ID = '140366'
TEST_AUTHENTICATION_KEY = 'dvZsZdp+CLyi6RqBJuJER88CrrROHLz3VNuAkZI5U6s='
TEST_CARD_PAYMENT_METHOD_CONFIGURATION_ID = '382448'
TEST_CUSTOMER_ID = '1234'

MOCK_CARD_DATA = VrpaymentRubySdk::AuthenticatedCardRequest.new(
  card_data: VrpaymentRubySdk::AuthenticatedCardDataCreate.new(
