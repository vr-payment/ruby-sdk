...
# vrpayment encryption util tests
class EncryptionUtilTest < Test::Unit::TestCase
  ...
  def test_valid_content
    is_content_valid = VrpaymentRubySdk::EncryptionUtil.is_content_valid(
  ...
  def test_invalid_public_key
    ...
    assert_raise_kind_of(VRPaymentSdkException) do
        VrpaymentRubySdk::EncryptionUtil.is_content_valid(
            @@valid_content_to_verify, @@valid_content_signature,
