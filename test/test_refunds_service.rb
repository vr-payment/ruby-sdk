...
class RefundsServiceTest < Test::Unit::TestCase
  ...
  def test_refund_of_completed_transaction_should_work
    ...
    assert_equal(
      VrpaymentRubySdk::RefundState::SUCCESSFUL,
      refund.state,
  ...
  def build_refund_create(transaction)
    VrpaymentRubySdk::RefundCreate.new(
      transaction: transaction.id,
      type: VrpaymentRubySdk::RefundType::MERCHANT_INITIATED_ONLINE,
