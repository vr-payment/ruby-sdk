...
Gem::Specification.new do |s|
  s.name        = "vrpayment-ruby-sdk"
  s.version     = VrpaymentRubySdk::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["wallee AG"]
  s.email       = ["ecosystem-team@wallee.com"]
  s.homepage    = "https://gateway.vr-payment.de/"
  s.summary     = "A ruby wrapper around the VR Payment API."
  s.description = "The VR Payment SDK allows an easy interaction with the VR Payment web service."
  s.license     = "Apache-2.0"
  s.metadata    = {
    "git" => "https://github.com/vr-payment/ruby-sdk"
  }
